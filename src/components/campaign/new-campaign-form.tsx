...
export function NewCampaignForm({onClose, onSubmitSuccess}: NewCampaignFormProps) {
    ...
    const handleSubmit = async () => {
        try {
            if (formData.mediaFiles.length === 0 || formData.neighborhoods.length === 0) {
                alert('Please select regions and upload at least one file.');
                return;
            }
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-2 space-y-2">
                                            <p className="text-2xl font-bold">₺6,000 <span
                                                className="text-sm font-normal text-gray-500">/month</span></p>
                                            ...
                                            <ul className="mt-4 space-y-2 text-sm">
                                                ...
                                                <li className="flex items-center gap-2">
                                                    <span className="text-yellow-500">•</span> Basic Targeting
                                                    (district-based)
                                                </li>
                                                <li className="flex items-center gap-2">
                            ...
                            <Card className="p-6 border-yellow-100 hover:border-yellow-300 transition-colors">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-2 space-y-2">
                                            <p className="text-2xl font-bold">₺12,000 <span
                                                className="text-sm font-normal text-gray-500">/month</span></p>
                                            ...
                                            <ul className="mt-4 space-y-2 text-sm">
                                                ...
                                                <li className="flex items-center gap-2">
                                                    <span className="text-yellow-500">•</span> Real-time Location
                                                    Targeting
                                                </li>
                                                <li className="flex items-center gap-2">
                            ...
                            <Card className="p-6 border-yellow-100 hover:border-yellow-300 transition-colors">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-2 space-y-2">
                                            <p className="text-2xl font-bold">₺25,000 <span
                                                className="text-sm font-normal text-gray-500">/month</span></p>
