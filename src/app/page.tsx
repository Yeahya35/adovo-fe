...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-white to-yellow-50">
      {/* Navigation */}
      <nav className="bg-white/80 backdrop-blur-md fixed w-full z-10 shadow-sm animate-slide-down">
      ...
      {isLoggedIn ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-6 border border-yellow-100">
                ...
                <div className="space-y-4">
                  ...
                  <button className="block w-full py-3 px-4 bg-gray-100 text-black rounded-xl text-center font-medium hover:bg-gray-200 transition-colors">
                    View Analytics
                  </button>
                </div>
              </div>
        ...
        <div className="pt-24 pb-16 px-4 sm:pt-32">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-4xl sm:text-6xl font-bold text-black mb-6 animate-fade-in">
            ...
            <div className="flex gap-4 justify-center">
              <Link
                href="/register"
                className="px-8 py-3 bg-black text-white rounded-full hover:bg-black transition-colors font-medium"
              >
                Start Advertising
              </Link>
              <Link
...
const FeatureCard = ({ title, description, icon }: FeatureCardProps) => (
  <div className="p-6 bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
...
const Step = ({ number, title, description }: StepProps) => (
  <div className="flex flex-col items-center text-center">
    <div className="w-12 h-12 bg-yellow-400 rounded-full flex items-center justify-center text-black font-bold mb-4">
      {number}
    </div>
    <h3 className="text-xl font-semibold mb-2 text-black">{title}</h3>
    <p className="text-black">{description}</p>
