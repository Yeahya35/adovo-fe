      ...
      <div className="max-w-7xl mx-auto px-4 pb-20">
        <div className="grid md:grid-cols-3 gap-8">
          {pricingTiers.map((tier) => (
            ...
            >
              {tier.popular && (
                <div className="absolute top-0 right-0 bg-yellow-400 text-black px-4 py-1 rounded-bl-xl rounded-tr-xl font-medium">
                  Popular
                </div>
              )}
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600">You can choose specific neighborhoods in Ankara where you want your ads to appear. Our network of taxi displays will show your ads when in those areas.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600">We accept static images and video ads in common formats (JPG, PNG, MP4). Our team will help ensure your ads meet our display specifications.</p>
            </div>
          </div>
        </div>
      </div>
